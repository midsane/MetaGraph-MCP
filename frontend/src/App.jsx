import { AppHeader } from './metagraph/components/AppHeader.jsx';
import { ErrorBanner } from './metagraph/components/ErrorBanner.jsx';
import { GlobalStyle } from './metagraph/components/GlobalStyle.jsx';
import { Sidebar } from './metagraph/components/Sidebar.jsx';
import { GovernanceSection } from './metagraph/sections/GovernanceSection.jsx';
import { IngestSection } from './metagraph/sections/IngestSection.jsx';
import { LineageSection } from './metagraph/sections/LineageSection.jsx';
import { RagSection } from './metagraph/sections/RagSection.jsx';
import { useMetagraphWorkspace } from './metagraph/useMetagraphWorkspace.js';
        ...
        <main className="mg-scroll min-w-0 flex-1 p-4 sm:p-6 lg:p-8">
          ...
          {workspace.activeTab === 'rag' && (
            <RagSection
              ...
              ragResults={workspace.ragResults}
